  ...
  <div className="articleContent">
	<div className="articleIntro">
		...
		<ul>
			...
			<li>Delivered a story about Emily Coli, a bacterium who needs to get out of a dying city, and the forbidden love she has with the white blood cell who doesn't want her gone.</li>
	...
	<p className="articleParagraph">So, how was I to fix this? Widening the avatar’s hit-box would remove the dexterity challenge, but alter movement in other areas and defy conventions for platformer avatars (I'm not responsible for any trauma resulting if the reader imagines ‘wide Mario’.) The solution I arrived at was adding a ‘carry’ mechanic. An air-borne clone falling near the top of another would snap into a ‘being carried’ state. Their movement would be arrested, replaced by the movement of the clone beneath them. Because the range of the snap-to-carry was customizable, I could to mitigate the avatars’ narrow hitboxes, while also correcting an issue where players had managed to land their clones on top of each other but then accidentally walked off. This also introduced a new space of design to explore, using carry to expand the range of movement for clones previously limited by the mirrored movement restriction. That, and a few other fun, little things.</p>
	...
	<p className="articleParagraph">But further playtests exposed the need for more refinement. When players had avatars were in the carry state, they would become accustomed to the bottom avatar’s movement. As they triggered a jump, more often than not the player continued inputting movement as the bottom clone, and the top clone’s mirrored movement sent them flying off in the opposite direction. This was a natural outgrowth of the game’s mechanics, but it left players annoyed. Again, players were solving the puzzle in their head, but failing an input challenge. Some playtesters got a laugh out of it, but more were frustrated.</p>
	...
	<p className="articleParagraph">If I could go back, I would add a kind of ‘coyote time’ to the throw, a small period after the throw where movement from the bottom clone could still update the velocity of the top clone. Alas, the game is released. I can’t.</p>
