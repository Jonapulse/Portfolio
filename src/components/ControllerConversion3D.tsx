...
export const ControllerConversion3D: React.VFC = () => (
  <div className="articleContent">
	  ...
	  <p className="articleIntro">I modified a 2D Raycasting Character Controller to function in 3D with a designer-controlled reference frame [wording.] Here’s how and why I did it.</p>
