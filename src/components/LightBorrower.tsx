...
export const LightBorrower: React.VFC = () => (
  <div className="articleContent">
	<div className="articleIntro">
		<p className="articleTitle" style={{position: 'relative'}}><p style={{position: 'absolute', left:'30px', top: '30px', color: 'black'}}>Light Borrower</p> <img src="./art/lightBorrowerHeaderLight.png"></img></p>
		...
		<ul>
			...
			<div className="articlePictureRight imgTweak"><img src="./art/windowSideBySide.jpg" style={{width: '347px', height: '300px'}}></img><div className="subTitle">Stained glass window. My concept, artist's rendition.</div></div>
				<ul>
